        ...
        <div class="container">
          ...
          >{{ formData.name }}</h2>-->
            ...
            <form>
                ...
                <b-field :message="formErrorData.phone" :type="{ 'is-danger': formErrorData.phone }" label="Phone number">
                ...
                <b-field :message="formErrorData.email" :type="{ 'is-danger': formErrorData.email }" label="Email">
    
                    <b-input v-model.trim="formData.email" type="email" placeholder="john@address.com"></b-input>
    
                </b-field>
    
                <b-field :message="formErrorData.address" :type="{ 'is-danger': formErrorData.address }" label="Address">
